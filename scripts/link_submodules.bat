...
mklink /j ..\arcor2_AREditor\Assets\Submodules\NativeWebSocket ..\arcor2_AREditor\Submodules\NativeWebSocket
...
del /F /Q ..\arcor2_AREditor\Assets\Submodules\NativeWebSocket\NativeWebSocket\Assets\WebSocketExample\* 
pause