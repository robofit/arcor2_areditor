...
public class ActionObjectMetadata {
    ...
    public bool ActionsLoaded {
        get => _actionsLoaded; set => _actionsLoaded = value;
    }
    public Dictionary<string, ActionMetadata> ActionsMetadata {
        get => _actionsMetadata; set => _actionsMetadata = value;
    }
    public bool Robot {
        get => _robot; set => _robot = value;
    }
    public string BaseObject {
        get => _baseObject; set => _baseObject = value;
    }
}
