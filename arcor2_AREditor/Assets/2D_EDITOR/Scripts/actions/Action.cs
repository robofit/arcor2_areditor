...
public class Action
{
    ...
    public Dictionary<string, ActionParameter> Parameters { get => _parameters; set => _parameters = value; }
    public ActionMetadata Metadata { get => _metadata; set => _metadata = value; }
    public InteractiveObject InteractiveObject { get => _interactiveObject; set => _interactiveObject = value; }
}
