...
public class ActionParameter
{
    ...
    public ActionParameterMetadata ActionParameterMetadata { get => _actionParameterMetadata; set => _actionParameterMetadata = value; }
    public JSONObject Value { get => _value; set => _value = value; }
}
