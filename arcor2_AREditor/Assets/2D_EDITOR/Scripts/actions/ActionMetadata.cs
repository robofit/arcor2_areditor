...
public class ActionMetadata
{
    ...
    public bool Composite { get => _composite; set => _composite = value; }
    public bool Blackbox { get => _blackbox; set => _blackbox = value; }
    public string Name { get => _name; set => _name = value; }
    public Dictionary<string, ActionParameterMetadata> Parameters { get => _parameters; set => _parameters = value; }
}
