...
namespace DanielLochner.Assets.SimpleSideMenu
{
    ...
    public class SimpleSideMenuEditor : Editor
    {
        ...
        private SerializedProperty placement, defaultState, transitionSpeed, thresholdDragSpeed, thresholdDraggedFraction, handle, handleDraggable, handleToggleStateOnPressed, menuDraggable, useOverlay, overlayColour, useBlur, blurRadius, overlaySwipe, overlayRetractOnPressed;
